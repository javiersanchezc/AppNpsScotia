...
public class CsvToSqlServerHuddlesExport {
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePathwm_huddles_export = properties.getProperty("inputFilePathwm_huddles_export");
                this.tableNamehuddles_export = properties.getProperty("tableNamehuddles_export");
    ...
    public void convertCsvToSqlServer() {
        try {
            ...
            try {
                CSVReader csvReader = new CSVReader(new FileReader(this.inputFilePathwm_huddles_export));
                try {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + this.tableNamehuddles_export + " VALUES (";
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamehuddles_export, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
    ...
    private ConsultaResultado consultarTabla(Connection connection, String tableName, LocalDate fechaConsulta) throws SQLException {
        String sql = "SELECT COUNT(*) FROM " + tableName + " WHERE Creation_Date_EST = ?";
