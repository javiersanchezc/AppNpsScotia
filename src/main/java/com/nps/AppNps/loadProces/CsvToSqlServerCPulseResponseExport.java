...
public class CsvToSqlServerCPulseResponseExport {
    ...
    private String logFilename ="C:/data/CPulseResponseExport.log";
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePathwm_cPulse_response_export = properties.getProperty("inputFilePathwm_cPulse_response_export");
                this.tableNamecPulse_response_export = properties.getProperty("tableNamecPulse_response_export");
    ...
    public void convertCsvToSqlServer() {
        try {
            ...
            try {
                CSVReader csvReader = new CSVReader(new FileReader(this.inputFilePathwm_cPulse_response_export));
                try {
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamecPulse_response_export, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
