...
public class CsvToSqlServerWPulseCallbacksExport {
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePathwm_callback = properties.getProperty("inputFilePathwm_callback");
                this.tableNamewPulse_Callbacks = properties.getProperty("tableNamewPulse_Callbacks");
                this.jdbcUrl = properties.getProperty("jdbcUrl");
                this.errorFilePath = properties.getProperty("errorFilePath");
                System.out.println(this.inputFilePathwm_callback);
                if (input != null)
                    input.close();
    ...
    public void convertCsvToSqlServer() {
        try {
            ...
            try {
                CSVReader csvReader = new CSVReader(new FileReader(this.inputFilePathwm_callback));
                try {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + this.tableNamewPulse_Callbacks + " VALUES (";
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamewPulse_Callbacks, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
