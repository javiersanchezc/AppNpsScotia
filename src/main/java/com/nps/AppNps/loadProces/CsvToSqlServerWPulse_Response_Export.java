...
public class CsvToSqlServerWPulse_Response_Export {
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePath = properties.getProperty("inputFilePath");
                this.tableNamewPulse_Response_Export = properties.getProperty("tableNamewPulse_Response_Export");
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + this.tableNamewPulse_Response_Export + " VALUES (";
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamewPulse_Response_Export, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
    ...
    private ConsultaResultado consultarTabla(Connection connection, String tableName, LocalDate fechaConsulta) throws SQLException {
        String sql = "SELECT COUNT(*) FROM " + tableName + " WHERE ResponseDate = ?";
