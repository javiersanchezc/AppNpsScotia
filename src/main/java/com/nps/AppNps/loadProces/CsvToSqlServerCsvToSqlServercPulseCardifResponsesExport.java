...
public class CsvToSqlServerCsvToSqlServercPulseCardifResponsesExport {
    ...
    private String logFilename ="C:/data/cPulseCardifResponsesExport.log";
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePathwm_cPulseInsuranceCardifResponsesExport = properties.getProperty("inputFilePathwm_cPulseInsuranceCardifResponsesExport");
                this.tableNamecPulseInsuranceCardifResponsesExport = properties.getProperty("tableNamecPulseInsuranceCardifResponsesExport");
    ...
    public void convertCsvToSqlServer() {
        try {
            ...
            try {
                CSVReader csvReader = new CSVReader(new FileReader(this.inputFilePathwm_cPulseInsuranceCardifResponsesExport));
                try {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + this.tableNamecPulseInsuranceCardifResponsesExport + " VALUES (";
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamecPulseInsuranceCardifResponsesExport, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
