...
public class CsvToSqlServerCsvToSqlServercPulseCardiffOptOutExport {
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePathwm_cPulseInsuranceCardiffOptOutExport = properties.getProperty("inputFilePathwm_cPulseInsuranceCardiffOptOutExport");
                this.tableNamecPulseInsuranceCardiffOptOutExport = properties.getProperty("tableNamecPulseInsuranceCardiffOptOutExport");
    ...
    public void convertCsvToSqlServer() {
        try {
            ...
            try {
                CSVReader csvReader = new CSVReader(new FileReader(this.inputFilePathwm_cPulseInsuranceCardiffOptOutExport));
                try {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + this.tableNamecPulseInsuranceCardiffOptOutExport + " VALUES (";
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamecPulseInsuranceCardiffOptOutExport, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
