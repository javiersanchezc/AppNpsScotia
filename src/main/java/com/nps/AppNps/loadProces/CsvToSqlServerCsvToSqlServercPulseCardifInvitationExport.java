...
@Component
public class CsvToSqlServerCsvToSqlServercPulseCardifInvitationExport {
    ...
    private void loadProperties() {
        ...
        try {
            ...
            try {
                ...
                this.inputFilePathwm_cPulseInsuranceCardifInvitationExport = properties.getProperty("inputFilePathwm_cPulseInsuranceCardifInvitationExport");
                this.tableNamecPulseInsuranceCardifInvitationExport = properties.getProperty("tableNamecPulseInsuranceCardifInvitationExport");
    ...
    public void convertCsvToSqlServer() {
        try {
            ...
            try {
                CSVReader csvReader = new CSVReader(new FileReader(this.inputFilePathwm_cPulseInsuranceCardifInvitationExport));
                try {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + this.tableNamecPulseInsuranceCardifInvitationExport + " VALUES (";
    ...
    public List<ConsultaResultado> realizarConsultas(LocalDate fechaConsulta) {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl)) {
            resultados.add(consultarTabla(connection, tableNamecPulseInsuranceCardifInvitationExport, fechaConsulta));
        } catch (SQLException e) {
            e.printStackTrace();
        }
        return resultados;
