...
@Service
public class CardifServiceimpl implements ICardifRepository {
    @Value("${jdbcUrl}")
    private String jdbcUrl;

    @Value("${inputFilePathwm_cPulseInsuranceCardifCallbackExport}")
    private String inputFilePathwm_cPulseInsuranceCardifCallbackExport;

    @Value("${inputFilePathwm_cPulseInsuranceCardiffOptOutExport}")
    private String inputFilePathwm_cPulseInsuranceCardiffOptOutExport;

    @Value("${inputFilePathwm_cPulseInsuranceCardifInvitationExport}")
    private String inputFilePathwm_cPulseInsuranceCardifInvitationExport;

    @Value("${inputFilePathwm_cPulseInsuranceCardifResponsesExport}")
    private String inputFilePathwm_cPulseInsuranceCardifResponsesExport;



    @Value("${tableNamecPulseInsuranceCardifCallbackExport}")
    private String tableNamecPulseInsuranceCardifCallbackExport;

    @Value("${tableNamecPulseInsuranceCardiffOptOutExport}")
    private String tableNamecPulseInsuranceCardiffOptOutExport;

    @Value("${tableNamecPulseInsuranceCardifInvitationExport}")
    private String tableNamecPulseInsuranceCardifInvitationExport;

    @Value("${tableNamecPulseInsuranceCardifResponsesExport}")
    ...
    public void Load_cPulse_Insurance_Cardif_OptOut_Export(String inputFilePath, String outputFilePath) {
      ...
      //  CardiffOptOutExport.convertCsvToSqlServer();
        String fileLog = "C:/data/"+"cPulse_Insurance_Cardif_OptOut_Export.log";
        CsvToSqlServerMaster CPulseCallBacksExport = new CsvToSqlServerMaster(jdbcUrl, inputFilePathwm_cPulseInsuranceCardiffOptOutExport, tableNamecPulseInsuranceCardiffOptOutExport, errorFilePath, fileLog);
    ...
    public void Load_cPulse_Insurance_Cardif_Callback_Export(String inputFilePath, String outputFilePath) {
       ...
       // CsvToSqlServerCsvToSqlServercPulseCardifCallbackExport CardifCallbackExport = new CsvToSqlServerCsvToSqlServercPulseCardifCallbackExport();
        ...
        String fileLog = "C:/data/"+"cPulse_Insurance_Cardif_Callback_Export.log";
        CsvToSqlServerMaster CPulseCallBacksExport = new CsvToSqlServerMaster(jdbcUrl, inputFilePathwm_cPulseInsuranceCardifCallbackExport, tableNamecPulseInsuranceCardifCallbackExport, errorFilePath, fileLog);
        CPulseCallBacksExport.convertCsvToSqlServer();
    }
    ...
    public void Load_cPulse_Insurance_Cardif_Responses_Export(String inputFilePath, String outputFilePath) {
       ...
       // CsvToSqlServerCsvToSqlServercPulseCardifResponsesExport CardifResponsesExport = new CsvToSqlServerCsvToSqlServercPulseCardifResponsesExport();
        ...
        String fileLog = "C:/data/"+"cPulse_Insurance_Cardif_Responses_Export.log";
        CsvToSqlServerMaster CPulseCallBacksExport = new CsvToSqlServerMaster(jdbcUrl, inputFilePathwm_cPulseInsuranceCardifResponsesExport, tableNamecPulseInsuranceCardifResponsesExport, errorFilePath, fileLog);
        CPulseCallBacksExport.convertCsvToSqlServer();
    }
