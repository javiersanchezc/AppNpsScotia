...
@Service
public class CPulseServiceimpl implements ICPulseRepository {

    @Value("${jdbcUrl}")
    private String jdbcUrl;

    @Value("${inputFilePathwm_cPulse_callback_export}")
    private String inputFilePathwm_cPulse_callback_export;
    @Value("${inputFilePathwm_cPulse_response_export}")
    ...
    @Value("${tableNamecPulse_response_export}")
    ...
    public void Load_cPulse_Response_Export(String inputFilePath, String outputFilePath) {
        ...
        String fileLog = "C:/data/"+"cPulse_Response_Export.log";
        CsvToSqlServerMaster CPulseCallBacksExport = new CsvToSqlServerMaster(jdbcUrl, inputFilePathwm_cPulse_response_export, tableNamecPulse_response_export, errorFilePath, fileLog);
    ...
    public void Load_cPulse_Invitation_Export(String inputFilePath, String outputFilePath) {
       ...
       // CPulseInvitationsExport.convertCsvToSqlServer();
        String fileLog = "C:/data/"+"cPulse_Invitation_Export.log";
        CsvToSqlServerMaster CPulseCallBacksExport = new CsvToSqlServerMaster(jdbcUrl, inputFilePathwm_cPulse_Invitation_Export, tableNamecPulse_Invitation_Export, errorFilePath, fileLog);
        CPulseCallBacksExport.convertCsvToSqlServer();
    }
    ...
    public void Load_cPulse_Callback_Export(String inputFilePath, String outputFilePath) throws CsvValidationException {
        ...
        CSV csvTransformer = new CSV(inputFilePath, outputFilePath, headerFileout);
        csvTransformer.transformCsv();
        String fileLog = "C:/data/"+"cPulse_Callback_Export.log";
        CsvToSqlServerMaster CPulseCallBacksExport = new CsvToSqlServerMaster(jdbcUrl, inputFilePathwm_cPulse_callback_export, tableNamecPulse_Callbacks_Export, errorFilePath, fileLog);
       CPulseCallBacksExport.convertCsvToSqlServer();
    }
}